	...
	private parts = [
...

		{
			...
			dialogue: [
				...
				{name: 'Omonar', dialogue: '... but I have since lost his review, so I need to write my own.'},
				// {name: 'Omonar', dialogue: 'There is still quite a bit of work to be done to make sense of all this literature.'},
				...
				{name: 'Omonar', dialogue: 'Could you help me critically review this pile of books?'},
